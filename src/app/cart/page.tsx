				...
				<div className="w-full lg:w-7/12 shadow-lg border border-gray-100 p-8 rounded-lg flex flex-col gap-8">
					{activeStep === 1 ? (
						...
						<p className="text-sm text-gray-500">
							Please fill in the shipping form to
							continue.
						</p>
					)}
				</div>
				...
				<div className="w-full lg:w-5/12 shadow-lg border border-gray-100 p-8 rounded-lg flex flex-col gap-8 h-max">
					...
					{activeStep === 1 && (
						<button
							...
							className="w-full bg-gray-800 hover:bg-gray-900 text-white p-2 rounded-lg cursor-pointer flex items-center justify-center gap-2"
						>
							Continue
